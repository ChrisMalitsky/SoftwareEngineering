...
%Finds the number of compressor decay coefficients that have a value of 0, 1, 2.
comp0 = 0;
comp1 = 0;
comp2 = 0;
...
hComp.Title = 'Compressor Confusion Matrix';
...
hTurb.Title = 'Turbine Confusion Matrix';
hTurb.XLabel = 'Predictions';
hTurb.YLabel = 'Actual';

%Export compressor coefficients to a .txt file
comptable = array2table(compressorCos,...
                        'VariableNames',{'Alert','Warning','Normal'});
writetable(comptable,'compressordata.txt');

%Export turbine coefficients to a .txt file
turtable = array2table(turbineCos,...
                        'VariableNames',{'Alert','Warning','Normal'});
writetable(turtable,'trubinedata.txt');
